...
// {/* <ArrowForwardIosRoundedIcon sx = {{ fontSize: '1rem', color: '#555c' }} /> */}
// import ArrowBackIosRoundedIcon from '@mui/icons-material/ArrowBackIosRounded';
// {/* <ArrowBackIosRoundedIcon sx = {{ fontSize: '1rem', color: '#555c' }} /> */}
// import AccountCircleRoundedIcon from '@mui/icons-material/AccountCircleRounded';
// {/* <AccountCircleRoundedIcon sx = {{ fontSize: '1rem', color: '#555c' }} /> */}
// import DeleteRoundedIcon from '@mui/icons-material/DeleteRounded';
// {/* <DeleteRoundedIcon sx = {{ fontSize: '1rem', color: '#ff4242dd' }} /> */}
// import LocalPhoneRoundedIcon from '@mui/icons-material/LocalPhoneRounded';
// {/* <LocalPhoneRoundedIcon sx = {{ fontSize: '1rem', color: '#ff4242dd' }} /> */}
// import EditRoundedIcon from '@mui/icons-material/EditRounded';
// {/* <EditRoundedIcon sx = {{ fontSize: '1rem', color: '#ff4242dd' }} /> */}
...
export const BookmarksIcon = ({ id = 'globalBootstrapIconsBookmarked', width = '20', height = '20', color = '#0288e8' }) => {
    return (
