...
import { cancel } from '../../../../../../../redux/customer/dashboard/book/edit/actions';
...
const Submit = () => {
    ...
    const { loading } = useSelector(state => state.customerDashboardBookCancel);
    ...
    const styling = {
        backgroundColor: loading ? '#222' : '#1a1a1a',
        padding: '3px 12px',
